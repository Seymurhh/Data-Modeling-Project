...
numeric_cols <- sapply(train.dat.o, is.numeric)

# Apply normalization only to numeric columns
train.dat.norm <- as.data.frame(lapply(train.dat.o[, numeric_cols], normalize))
test.dat.norm <- as.data.frame(lapply(test.dat.o[, numeric_cols], normalize))
